...
- **Colors** — `background`, `surface`, `foreground`, `primary`, `border`, status colors (`success`, `warning`, `destructive`, `information`, `discovery`), and their `*-hovered` / `*-pressed` / `*-foreground` variants.
